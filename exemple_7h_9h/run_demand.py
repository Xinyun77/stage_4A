...
if __name__ == '__main__':
    ...
    uber.add_depot("m1003028151", capacity=10)  #  52.36296620235635, 4.804315400116319   44% uber have benn found
    uber.add_depot("m1014426667", capacity=10)
    uber.add_depot("m1016716190", capacity=10)  #  52.39025250329249, 4.8849803001694525
    uber.add_depot("m1029631236", capacity=10)  #  52.384873203248524, 4.881513100166867
    uber.add_depot("m1028640996", capacity=10) #  52.375971803527186, 4.902527200182959
    ...
    demand_with_uber = percentage_uber(1e-3, demand_data)  # with a percentage of uber
