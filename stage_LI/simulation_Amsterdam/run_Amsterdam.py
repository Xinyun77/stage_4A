...
if __name__ == '__main__':
    ...
    #bbox = get_bounding_box(mmgraph.roads)
    #bbox = (584294.2261693971, 5710429.208945983, 737546.9351569484, 5901883.143939297)
   # odlayer = generate_matching_origin_destination_layer(mmgraph.roads)
    ...
    #odlayer = generate_grid_origin_destination_layer(bbox.xmin, bbox.ymin, bbox.xmax, bbox.ymax, 50, 70)
    #print(odlayer.origins)
   # print(odlayer.destinations)
    print('oldlayer \n')

    #mmgraph.connect_origin_destination_layer(odlayer, 1e3)
    mmgraph.add_origin_destination_layer(odlayer)
    end_oldlayer = time.time()
    print(end_oldlayer - start)
